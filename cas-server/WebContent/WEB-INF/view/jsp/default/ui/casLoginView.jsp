<%
    ...
    if ( "fetchlt".equals( cmd ) ) {
        ...
        %><%= ((javax.servlet.http.HttpServletRequest)request).getSession(true).getId() %>
${flowExecutionKey}<%
    } else if ( "validate".equals( cmd ) ) {
        // if request was just to validate username/password and we have to display this form, just send the user
        // to the error URL.
        response.sendRedirect( request.getParameter("on_error") );
    } else { %>
